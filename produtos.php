...
<body>
    ...
    <div class="position-fixed bottom-0 z-3 w-100 d-block d-md-none " style="background-color: red; height: 80px;">
        <nav class="navbar w-100 top-0 text-center justify-content-center">
    ...
    <div class="container-fluid text-white w-100 d-none d-md-block p-2" style="background-color: red;">
        ...
        <div class="row text-center" style="height: 100px;">
            <div class="col-sm-12" id="nao-sei" style="height: 100px;">
                <?php include('layouts/nav-web.php') ?>
            </div>
        </div>
    </div>
    <div class="position-fixed top-0 z-3 w-100 d-block d-md-none " style="background-color: red; height: 100px;">
    ...
    <main class="container-fluid">
        <div class="row mt-3">
            <div class="col col-md-2 d-none d-md-block d-xl-block">
                <?php include('layouts/menu-lateral.php'); ?>
            </div>
